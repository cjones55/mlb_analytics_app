...
def main():
    ...
    if choice == "1":
        ...
        subprocess.run([
            "python3", os.path.join(BASE_DIR, "single_team_simulator.py"),
            "--payroll", str(payroll),
            "--war", str(war)
        ])
        ...
        cmd = [
            "python3", os.path.join(BASE_DIR, "standings_projections.py"),
            "--csv", proj_csv,
        ...
        subprocess.run([
            "python3", os.path.join(BASE_DIR, "free_agent_evaluator.py"),
            "--team", team_name,
        ...
        subprocess.run([
            "python3", os.path.join(BASE_DIR, "r2_analysis.py"),
            "--finance_csv", os.path.join(BASE_DIR, "mlb_finance_data_1.csv"),
            "--proj_csv", os.path.join(BASE_DIR, "projected_mlb_team_data.csv")
        ])
